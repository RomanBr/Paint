mathFun.max1 = function (Arr, F) {
	if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b){return (F(b) - F(a))})[0];
	}

mathFun.max2 = function (Arr, F) {
		if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b){return F(b - a)})[0];
	}

mathFun.min1 = function (Arr, F) {
		if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b){return (F(a) - F(b))})[0];
	}

mathFun.min2 = function (Arr, F) {
		if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b){return F(a - b)})[0];
	}

mathFun.m1 = function (Arr, F) {
	if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b){return (F(b) + F(a))})[0];
	}

mathFun.m2 = function (Arr, F) {
		if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b){return F(b + a)})[0];
	}
...
mathFun.m3 = function (Arr, F) {
		if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b) {return F(a)})[0];
	}

mathFun.m4 = function (Arr, F) {
		if ((arguments.length > 1) && (typeof Arr == 'number')) Arr = [].slice.call(arguments);
		F = mathFun[F];
		return Arr.sort(function(a, b) {return F(a)})[0];
	}
